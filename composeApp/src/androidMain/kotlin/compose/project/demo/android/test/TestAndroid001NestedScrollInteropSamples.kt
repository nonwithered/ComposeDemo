...
object TestAndroid001NestedScrollInteropSamples : TestCase<TestAndroid001NestedScrollInteropSamples> {

    @Composable
    override fun BoxScope.Content() {
        CollapsingToolbarComposeViewComposeNestedScrollInteropSample()
    }

    @Composable
    private fun ComposeInCooperatingViewNestedScrollInteropSample() {
    ...
    @Composable
    private fun ViewInComposeNestedScrollInteropSample() {
        Box(
            Modifier
                .fillMaxSize()
    ...
    @Composable
    private fun CollapsingToolbarComposeViewComposeNestedScrollInteropSample() {
